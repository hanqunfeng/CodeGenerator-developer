...
public class Table {
	...
	public String getSequence() {
		return this.sqlName.toUpperCase().replace("TBL_", "SEQ_");
	}
	...
	public Table(Table t) {
		...
		if(StringHelper.isBlank(System.getProperty("className"))){
	...
	/** 数据库中表的表备注unicode */
	public String getUnicodeRemarks() {
		return chinaToUnicode(remarks);
	}
